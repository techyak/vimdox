...
//VIMYAK: 
uint8_t keyboard_modifier_keys_temp=0;
uint8_t keyboard_keys_temp[6]={0,0,0,0,0,0};
//end VIMYAK incursion
...
int main(void) {
  ...
  //end VIMYAK incursion
    ...
    //VIMYAK incursion: the primary keyhandler loop
    vimyak_keyhandler();
    //END incursion
    
    
    /* VIMYAK incursion: this is being handled by the vimyak_keyhandler
